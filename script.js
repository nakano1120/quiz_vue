    ...
    data: {
      quiz:[
        [
          ...
          {question:"縄文時代、中小動物を狩るために「？？」が発明された。",answer:"弓矢"},
          {question:"縄文時代の人々は、台地などに「？？住居」の集落を営み、住居の中央には炉が設けられた。",answer:"竪穴住居"},
          {question:"あらゆる自然物や自然現象に霊威を認める考え方を「？？？」という。",answer:"アニミズム"},
        ]
      ],
      items:[
        "原始時代(簡単)",
